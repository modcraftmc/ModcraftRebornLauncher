...
public class StepXblXstsToken extends AbstractStep<StepFullXblSession.FullXblSession, StepXblXstsToken.XblXsts<?>> {
    ...
    public static final class XblXstsToken implements StepResult<StepFullXblSession.FullXblSession>, XblXsts<StepFullXblSession.FullXblSession> {
    ...
    public interface XblXsts<P extends StepResult<?>> extends StepResult<P> {
